...
(function (global) {
  ...
  const DEFAULT_WORDS = ["sроnsоrеd", "promoted"];
    ...
    shadow.innerHTML = `
      ...
      <div class="backdrop" id="backdrop">
        <div class="modal" id="modalBox">
          ...
          <textarea id="inp" placeholder="my ward, sponsored, ads..."></textarea>
          <div class="btn-row">
